...
import com.example.restapi.databinding.UserListBinding
...
class HomeAdapter(private var dataMahasiswa: List<DataMahasiswa>): RecyclerView.Adapter<HomeAdapter.ViewHolder>() {
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        holder.binding.cardView.setOnClickListener{
            ...
            Navigation.findNavController(it).navigate(com.example.restapi.R.id.action_homeFragment_to_detailFragment2,
            bundle)
        }
    }
}